...
./perf stat -a --cpu 0,1 -e cycles,instructions,cpu-clock,context-switches -I 100 --per-core -o perf.txt ./perf_test.x -w hotplug --alt_list u1,d1,u1,d1,u1 -m 0 -C 1 > tmp.txt
