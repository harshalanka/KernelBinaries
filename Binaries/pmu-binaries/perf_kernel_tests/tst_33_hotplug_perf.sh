...
./perf stat -a --cpu 0-3 -e cycles,instructions,cpu-clock,context-switches -I 100 --per-core -o perf.txt sh ./tst_33_hotplug_perf_1.sh
./gawk -v hp_cpu=1 -v non_hp_cpu=0 -f tst_32_hotplug_perf.awk perf.txt
./gawk -v hp_cpu=2 -v non_hp_cpu=3 -f tst_32_hotplug_perf.awk perf.txt
exit
echo "analysis script not yet implemented"
